...
NativeCollection.prototype.insert = function(docs, opts, cb) {
    return require('../mdbgoose').autoconn.collection(this.name).insert(docs)
    .nodeify(cb);
};

NativeCollection.prototype.remove = function(selector, opts, cb) {
    return require('../mdbgoose').autoconn.collection(this.name).remove(selector, opts)
    .nodeify(cb);
};

NativeCollection.prototype.update = function(selector, doc, opts, cb) {
    return require('../mdbgoose').autoconn.collection(this.name).update(selector, doc, opts)
    .nodeify(cb);
};
