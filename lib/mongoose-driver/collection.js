...
NativeCollection.prototype.findMdb = function(id, cb) {
	...
	.then(function(conn){
		return conn.collection(this.name).find(id);
	})
	.nodeify(cb);
};
...
NativeCollection.prototype.findForUpdate = function(id, cb) {
	...
	.then(function(conn){
		return conn.collection(this.name).findForUpdate(id);
	})
	.nodeify(cb);
};
...
NativeCollection.prototype.findByIndex = function(field, value, cb){
	...
	.then(function(conn){
		return conn.collection(this.name).findByIndex(field, value);
	})
	.nodeify(cb);
};
...
NativeCollection.prototype.findCached = function(id, cb){
	...
	.then(function(conn){
		return conn.collection(this.name).findCached(id);
	})
	.nodeify(cb);
};
...
NativeCollection.prototype.remove = function(selector, opts, cb) {
	...
	.then(function(conn){
		return conn.collection(this.name).remove(selector._id);
	})
	.nodeify(cb);
};
...
NativeCollection.prototype.update = function(selector, doc, opts, cb) {
	...
	.then(function(conn){
		return conn.collection(this.name).update(selector._id, doc['$set']);
	})
	.nodeify(cb);
};
