...
MemdbCollection.prototype.save = function(doc, opts, cb) {
    throw new Error('Collection#save unimplemented by driver');
};

MemdbCollection.prototype.findAndModify = function() {
    throw new Error('Collection#findAndModify unimplemented by driver');
};

MemdbCollection.prototype.findAndRemove = function() {
...
for (var i in Collection.prototype) {
    ...
    (function(i){
        ...
        var needReplace = ['find', 'findOne', 'insert', 'remove', 'save', 'update'];
        var funcName = i;
