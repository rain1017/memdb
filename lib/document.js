...
var AsyncLock = require('asyncLock');
...
var Document = function(opts){ //jshint ignore:line
	...
	this.lock = new AsyncLock({timeout : 1000000 * 1000}); // Never timeout
...
proto.find = function(connectionId, fields){
	...
	if(fields){
		fields.split(' ').forEach(function(field){
			...
			if(connectionId === self.connectionId && self.changed.hasOwnProperty(field)){
...
proto.ensureLocked = function(connectionId){
	if(this.connectionId !== connectionId){
		throw new Error('doc not locked');
	}
};
