...
proto.findForUpdate = function(name, id, fields){
	this._ensureActive();
	return this.db.findForUpdate(this._id, name, id, fields);
};
...
proto.findCached = function(name, id){
	this._ensureActive();
	return this.db.findCached(this._id, name, id);
};
